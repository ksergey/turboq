...
function(TurboQAddBenchmarksFromSourceList)
  ...
  foreach (TQ_LIST ${TQ_PARSED_UNPARSED_ARGUMENTS})
    foreach (TQ_ENTRY ${${TQ_LIST}})
        if (${TQ_ENTRY} MATCHES ".*_benchmark.cpp")
            string(REGEX REPLACE "^.*\/(.*)_benchmark\.cpp$" "\\1" benchmarkName "${TQ_ENTRY}")
            set(benchmarkName "${TQ_PARSED_PREFIX}-${benchmarkName}-benchmark")
...
function(TurboQExcludeTestsAndBenchmarksFromSourceList TQ_LIST)
    ...
    list(FILTER ${TQ_LIST} EXCLUDE REGEX ".*_benchmark.cpp")
    set(${TQ_LIST} ${${TQ_LIST}} PARENT_SCOPE)
endfunction()
